export function recomputeTeamStress(match) {
...
export function compactMatchView(match) {
    return {
        id: match.id,
...
export function resolveParallelWindow(match, byUserId, emit) {
...
export function checkReleaseResult(match) {
...
//# sourceMappingURL=coopMatchEngine.js.map