...
export async function repairNriFactionJsonColumns(prisma) {
    const fixes = [
...
export async function ensureNriMapLampTable(prisma) {
    await prisma.$executeRawUnsafe(`
    CREATE TABLE IF NOT EXISTS "NriMapLamp" (
      "id" TEXT NOT NULL PRIMARY KEY,
      "sessionId" TEXT NOT NULL,
      "x" REAL NOT NULL,
      "y" REAL NOT NULL,
      "color" TEXT NOT NULL DEFAULT '#ffb040',
      "on" BOOLEAN NOT NULL DEFAULT 1,
      "radius" REAL NOT NULL DEFAULT 12,
      "layer" TEXT NOT NULL DEFAULT 'city',
      "parentZoneKey" TEXT,
      "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
      FOREIGN KEY ("sessionId") REFERENCES "NriSession" ("id") ON DELETE CASCADE ON UPDATE CASCADE
    );
  `);
    await prisma.$executeRawUnsafe(`CREATE INDEX IF NOT EXISTS "NriMapLamp_sessionId_idx" ON "NriMapLamp"("sessionId");`);
}
export async function ensureNriMetroTables(prisma) {
    await prisma.$executeRawUnsafe(`
    CREATE TABLE IF NOT EXISTS "NriMetroLine" (
      "id" TEXT NOT NULL PRIMARY KEY,
      "sessionId" TEXT NOT NULL,
      "name" TEXT NOT NULL,
  ...
  `);
    await prisma.$executeRawUnsafe(`
    CREATE TABLE IF NOT EXISTS "NriMetroStation" (
      "id" TEXT NOT NULL PRIMARY KEY,
      "sessionId" TEXT NOT NULL,
      ...
      "x" REAL NOT NULL,
      "y" REAL NOT NULL,
      "districtZoneKey" TEXT,
      "extraLineIds" TEXT NOT NULL DEFAULT '[]',
      "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
      FOREIGN KEY ("sessionId") REFERENCES "NriSession" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
      FOREIGN KEY ("lineId") REFERENCES "NriMetroLine" ("id") ON DELETE CASCADE ON UPDATE CASCADE
    );
  `);
    await prisma.$executeRawUnsafe(`
    CREATE TABLE IF NOT EXISTS "NriMetroEdge" (
      "id" TEXT NOT NULL PRIMARY KEY,
      "sessionId" TEXT NOT NULL,
      "lineId" TEXT NOT NULL,
      "fromStationId" TEXT NOT NULL,
      "toStationId" TEXT NOT NULL,
      "travelSeconds" INTEGER,
      "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
      FOREIGN KEY ("sessionId") REFERENCES "NriSession" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
      FOREIGN KEY ("lineId") REFERENCES "NriMetroLine" ("id") ON DELETE CASCADE ON UPDATE CASCADE
    );
  `);
    await prisma.$executeRawUnsafe(`
    CREATE TABLE IF NOT EXISTS "NriMetroRide" (
      "id" TEXT NOT NULL PRIMARY KEY,
      "sessionId" TEXT NOT NULL,
  ...
  `);
    await prisma.$executeRawUnsafe(`
    CREATE TABLE IF NOT EXISTS "NriMetroShop" (
      "id" TEXT NOT NULL PRIMARY KEY,
      "sessionId" TEXT NOT NULL,
      "stationId" TEXT NOT NULL,
      "label" TEXT NOT NULL DEFAULT 'Лавка у станции',
      "catalogIds" TEXT NOT NULL DEFAULT '[]',
      "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
      FOREIGN KEY ("sessionId") REFERENCES "NriSession" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
      FOREIGN KEY ("stationId") REFERENCES "NriMetroStation" ("id") ON DELETE CASCADE ON UPDATE CASCADE
    );
  `);
    await prisma.$executeRawUnsafe(`CREATE INDEX IF NOT EXISTS "NriMetroLine_sessionId_idx" ON "NriMetroLine"("sessionId");`);
    await prisma.$executeRawUnsafe(`CREATE INDEX IF NOT EXISTS "NriMetroStation_sessionId_idx" ON "NriMetroStation"("sessionId");`);
    await prisma.$executeRawUnsafe(`CREATE INDEX IF NOT EXISTS "NriMetroEdge_sessionId_idx" ON "NriMetroEdge"("sessionId");`);
    await prisma.$executeRawUnsafe(`CREATE INDEX IF NOT EXISTS "NriMetroRide_sessionId_userId_idx" ON "NriMetroRide"("sessionId", "userId");`);
    await prisma.$executeRawUnsafe(`CREATE INDEX IF NOT EXISTS "NriMetroShop_sessionId_idx" ON "NriMetroShop"("sessionId");`);
}
...
export async function ensureNriMapSchema(prisma) {
    ...
    await ensureNriMapLampTable(prisma);
    await ensureNriMetroTables(prisma);
    await addSqliteColumn(prisma, `ALTER TABLE "NriMapZone" ADD COLUMN "megaDistrict" TEXT;`);
    await addSqliteColumn(prisma, `ALTER TABLE "NriMapZone" ADD COLUMN "color" TEXT;`);
    await addSqliteColumn(prisma, `ALTER TABLE "NriMapZone" ADD COLUMN "iconId" TEXT;`);
    ...
    await addSqliteColumn(prisma, `ALTER TABLE "NriMapZone" ADD COLUMN "rotation" INTEGER DEFAULT 0;`);
    await addSqliteColumn(prisma, `ALTER TABLE "NriMapZone" ADD COLUMN "artId" TEXT;`);
}
...
export async function ensureAllNriLoreDbColumns(prisma) {
    const steps = [
        ...
        { name: 'NriMapLamp table', run: () => ensureNriMapLampTable(prisma) },
        { name: 'NriMetro tables', run: () => ensureNriMetroTables(prisma) },
...
export function loadTopLevelZoneSeeds() {
