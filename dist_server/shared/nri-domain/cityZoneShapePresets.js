...
export const DISTRICT_SHAPE_PRESETS = [
...
export const TUNNEL_SHAPE_PRESETS = [
...
export const ALL_CITY_SHAPE_PRESETS = [
    ...DISTRICT_SHAPE_PRESETS,
    ...TUNNEL_SHAPE_PRESETS,
];
export function cityShapePresetById(id) {
    return ALL_CITY_SHAPE_PRESETS.find((p) => p.id === id) ?? null;
}
//# sourceMappingURL=cityZoneShapePresets.js.map