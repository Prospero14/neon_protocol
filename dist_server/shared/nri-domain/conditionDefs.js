...
export function getConditionDef(id) {
    return DEF_BY_ID.get(id);
}
export const CONDITION_LABELS = Object.fromEntries(CONDITION_DEFS.map((d) => [d.id, d.label]));
//# sourceMappingURL=conditionDefs.js.map