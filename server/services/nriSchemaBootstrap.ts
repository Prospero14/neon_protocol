...
export async function ensureNriMapLampTable(prisma: PrismaClient): Promise<void> {
  await prisma.$executeRawUnsafe(`
  ...
  `);
  await prisma.$executeRawUnsafe(
    `CREATE INDEX IF NOT EXISTS "NriMapLamp_sessionId_idx" ON "NriMapLamp"("sessionId");`
  );
}

export async function ensureNriMetroTables(prisma: PrismaClient): Promise<void> {
  await prisma.$executeRawUnsafe(`
  ...
  `);
  await prisma.$executeRawUnsafe(
    `CREATE INDEX IF NOT EXISTS "NriMetroLine_sessionId_idx" ON "NriMetroLine"("sessionId");`
  );
  await prisma.$executeRawUnsafe(
    `CREATE INDEX IF NOT EXISTS "NriMetroStation_sessionId_idx" ON "NriMetroStation"("sessionId");`
  );
  await prisma.$executeRawUnsafe(
    `CREATE INDEX IF NOT EXISTS "NriMetroEdge_sessionId_idx" ON "NriMetroEdge"("sessionId");`
  );
  await prisma.$executeRawUnsafe(
    `CREATE INDEX IF NOT EXISTS "NriMetroRide_sessionId_userId_idx" ON "NriMetroRide"("sessionId", "userId");`
  );
  await prisma.$executeRawUnsafe(
    `CREATE INDEX IF NOT EXISTS "NriMetroShop_sessionId_idx" ON "NriMetroShop"("sessionId");`
  );
}
