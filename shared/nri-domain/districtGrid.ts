...
export function tileDecayAmount(
  ...
  if (placeType === 'park' || placeType === 'plaza' || placeType === 'pond' || placeType === 'exit')
    return decay * 0.35;
  if (placeType === 'dump') return 0.55 + decay * 0.45;
  if (placeType === 'shack') return 0.4 + decay * 0.55;
