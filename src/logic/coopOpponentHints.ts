...
export function coopOpponentHintBody(role: CoopRole): string {
  switch (role) {
    ...
    case 'pm':
      return 'ИИ подкидывает бизнес-риски (scope/budget/panic): ваш SOFT-процесс гасит стресс, держит дедлайн и может чистить бизнесовые сбои на шине. В полигоне с ботами цепочку кода на шине собирает синтетический DEV — ваш фокус SOFT и сводка команды, а не клики по слотам кода.';
    default:
