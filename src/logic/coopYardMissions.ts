...
const JUNIOR_INTRO_CHAINS: TZStep[][] = [
  ...
  [
    { id: 'a', name: 'CLASS', requiredCardIds: ['syntax_class_decl', 'syntax_list_init'] },
    { id: 'b', name: 'METHOD', requiredCardIds: ['syntax_method_decl', 'syntax_try_catch'] },
    { id: 'c', name: 'TRY', requiredCardIds: ['syntax_try_catch', 'syntax_if'] },
    { id: 'd', name: 'IF_GUARD', requiredCardIds: ['syntax_if', 'syntax_foreach'] },
    { id: 'e', name: 'MAP_PUT', requiredCardIds: ['fn_map_put', 'fn_set_add'] },
    { id: 'f', name: 'SET_ADD', requiredCardIds: ['fn_set_add', 'fn_set_contains'] },
    { id: 'g', name: 'IMPORT_NETWORK', requiredCardIds: ['script_ssh', 'script_curl'] },
    { id: 'h', name: 'PING_GATEWAY', requiredCardIds: ['script_ping', 'script_curl'] },
    { id: 'i', name: 'LOG_SCAN', requiredCardIds: ['script_grep', 'script_cat'] },
    { id: 'j', name: 'OUT', requiredCardIds: ['fn_sysout_print', 'syntax_return_true'] },
  ],
  [
    /** Все id из CARD_LIBRARY — после normalize остаётся ≥2 варианта на шаг для джуна. */
    { id: 'a', name: 'CLASS', requiredCardIds: ['syntax_class_decl', 'syntax_list_init'] },
    { id: 'b', name: 'METHOD', requiredCardIds: ['syntax_method_decl', 'syntax_try_catch'] },
    { id: 'c', name: 'GUARD', requiredCardIds: ['syntax_if', 'syntax_foreach'] },
    { id: 'd', name: 'BRANCH', requiredCardIds: ['syntax_try_catch', 'syntax_if'] },
    { id: 'e', name: 'COLLECT', requiredCardIds: ['fn_map_put', 'fn_set_add'] },
    { id: 'f', name: 'ITER', requiredCardIds: ['syntax_foreach', 'syntax_if'] },
    { id: 'g', name: 'OUT', requiredCardIds: ['fn_sysout_print', 'syntax_return_true'] },
    { id: 'h', name: 'RET_A', requiredCardIds: ['syntax_return_true', 'syntax_return_false'] },
    { id: 'i', name: 'RET_B', requiredCardIds: ['syntax_return_false', 'fn_sysout_print'] },
    { id: 'j', name: 'CLOSE', requiredCardIds: ['syntax_method_decl', 'syntax_try_catch'] },
  ],
];
