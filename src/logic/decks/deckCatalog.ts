...
> = {
  ...
  admin: {
    ...
    ingress_lb: {
      title: 'Ingress / балансировка',
      hint: 'Nginx, round-robin, parallel upstream, CDN.',
      cardIds: ['infra_lb_nginx', 'infra_lb_round_robin', 'infra_lb_parallel', 'infra_cdn_edge'],
    },
    messaging: {
      title: 'Потоки и кэш',
      hint: 'Kafka-like шина, Redis, Prometheus.',
      cardIds: ['infra_kafka_bridge', 'infra_redis', 'infra_prometheus'],
    },
  },
};
