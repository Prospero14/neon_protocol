...
export const TRAITS: Trait[] = [
  ...
  { 
    id: 'overclocked', name: 'РАЗОГНАННЫЙ_ПРОЦЕССОР', type: 'COMBAT', category: 'COMBAT',
    description: '+256MB Infra (RAM) при старте, но +10% базовый Stress.' 
  },
  { 
    id: 'firewall_bypass', name: 'ОБХОД_ФАЙРВОЛА', type: 'COMBAT', category: 'COMBAT',
    description: 'Первый SCRIPT за ход требует на 128MB меньше Infra.' 
  },
  { 
    id: 'root_access', name: 'ROOT_ДОСТУП', type: 'COMBAT', category: 'COMBAT',
    description: 'Анализ Bug-стека: видишь следующую атаку врага.' 
  },

  // --- BEHAVIORAL TRAITS (Dialogue Rewards) ---
  {
    id: 'trait_merciless_validator', name: 'БЕСПОЩАДНЫЙ_ВАЛИДАТОР', type: 'GENERAL', category: 'COMBAT',
    description: '+10% урона, но -15% Max Stability (Stress limit). Твой код не прощает ошибок.'
  },
  {
    id: 'trait_silicon_altruist', name: 'КРЕМНИЕВЫЙ_АЛЬТРУИСТ', type: 'GENERAL', category: 'SOCIAL',
    description: 'На 20% дешевле сброс Stress у барменов. Репутация помощника систем.'
  },
  {
    id: 'trait_deep_packet_analyst', name: 'АНАЛИТИК_ГЛУБОКИХ_ПАКЕТОВ', type: 'GENERAL', category: 'SOFT',
    description: 'Шанс 15% получить бесплатную карту после боя. Дотошность окупается.'
  },
  {
    id: 'trait_glitch_anarchist', name: 'ГЛИТЧ-АНАРХИСТ', type: 'GENERAL', category: 'SRE',
    description: '+2 слота Neural Bus, но Stress в бою растет быстрее.'
  },
  {
    id: 'trait_street_ethos', name: 'УЛИЧНЫЙ_ЭТОС', type: 'GENERAL', category: 'SOCIAL',
