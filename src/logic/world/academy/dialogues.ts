...
export const academy_dialogues: Record<string, DialogueTree> = {
  ...
  bar_academy_refill: new DialogueBuilder('bar_academy_refill').withDistrict('academy')
    .addNode('intro', 'БУФЕТ «РЕФИЛЛ»', 'Кампусный узел питания. Без очереди к профессору — только биты и чистые логи.', [
      { text: 'Синт-кофе «Лекция» (15 Bits)', nextId: 'intro', cost: 15, effect: 'RESTORE_HP', amount: 22 },
