...
export const npc_nixanna_dialogue: DialogueTree = new DialogueBuilder('npc_nixanna')
  ...
  .addNode('intro_repeat', 'НИКСАННА', 'Мой герой-рендерер! После твоей зачистки Ритуала — артефактов стало на 73% меньше. Это не просто фикс, это апгрейд эпохи! Есть ещё задачи...', [
    { text: 'Давай следующий баг.', nextId: 'quest_start' },
    { text: '[Уйти]', nextId: 'LEAVE' }
  ])
  ...
  // === QUESTS ===
  .addNode('quest_recommendation', 'НИКСАННА', 'Академия? Профессор Архипов всё еще там сидит? Ха! Ладно, я дам тебе "Визуальный Образец" — это скомпилированный лог одной из моих лучших сцен. Покажи его ему, он оценит уровень оптимизации.', [
